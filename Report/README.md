...
- [x] Rapport
  ...
  - [x] Une liste des points faibles de votre projet (1/2 page)
  ...
  - [x] Et tout ce qui pourra m'aider a evaluer votre projet (XX pages)
    - [x] Joindre et expliquer tous les fichiers que nous avons rédigés pour notre compréhension
  - [x] Le log du projet
